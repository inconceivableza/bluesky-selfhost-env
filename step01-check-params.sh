...
python "$script_dir"/selfhost_scripts/check-env.py || { show_error "Missing params:" "please correct" ; exit 1 ;}

show_heading "Checking secrets configuration"
python "$script_dir"/selfhost_scripts/check-secrets.py || { show_error "Secrets issues:" "please review and correct" ; exit 1 ;}
