...
bgs_user_dids = {bgs_user.get('did'): bgs_user for bgs_user in data_files['bgs-users']}
...
bgs_actor_info_dids = {bgs_actor_info.get('did'): bgs_actor_info for bgs_actor_info in data_files['bgs-actor_infos']}
