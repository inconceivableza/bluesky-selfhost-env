...
cat ./docker-compose-builder.yaml | ./ops-helper/compose2envtable/venv/bin/python ./ops-helper/compose2envtable/main.py -l /tmp/envs.txt -o ./docs/env-container-vals.xlsx
